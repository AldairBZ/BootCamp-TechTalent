...
public class CRUDDirectores {
    // Datos de conexión a la base de datos
    static final String URL = "jdbc:mysql://localhost:3306/directores";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println(" Conexión exitosa a la base de datos 'directores'");
            ...
            //  Insertar registros en la tabla 'directores'
            ...
            //  Eliminar un registro de 'directores'
