...
public class UD7Tienda {
	...
	private static void mostrarMenuStock() {
		String[] opciones = { "Listar productos", "Consultar un producto", "Añadir o actualizar producto", "Volver al menú principal" };
		while (true) {
			String opcion = (String) JOptionPane.showInputDialog(null, "Selecciona una opción:", "Modo Administrador: Gestión de Stock",
					JOptionPane.PLAIN_MESSAGE, null, opciones, opciones[0]);
	...
	private static void mostrarMenuCompras() {
		...
		while (true) {
			String opcion = (String) JOptionPane.showInputDialog(null, "Selecciona una opción:", "Modo Usuario: Compras",
					JOptionPane.PLAIN_MESSAGE, null, opciones, opciones[0]);
